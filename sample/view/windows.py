    ...
    def show(self):
        ...
        if self.__single_analysis_flag:
            self.__back_button.set_label(
                self.__view.get_controller().get_i18n().get_strings().CANCEL_BUTTON_LABEL)
            self.__back_button.set_image(self.__cancel_button_image)
        else:
            self.set_title(
                self.__view.get_controller().get_i18n().get_strings().ANALYZE_SAMPLES_WINDOW_TITLE)
            self.__back_button.set_label(
                self.__view.get_controller().get_i18n().get_strings().BACK_BUTTON_LABEL)
...
# ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ #
    ...
    def transition_to_comet_being_edited(self):
        ...
        self.__editing_label.set_label(
            self.__view.get_controller().get_i18n().get_strings().SELECTION_WINDOW_COMET_BEING_EDITED_LABEL.format(
                comet_number))
        ...
        if self.__view.get_controller().get_editing():
            ...
            if comet_view is not None:
                ...
                self.__selection_label.set_label(
                    self.__view.get_controller().get_i18n().get_strings().SELECTION_WINDOW_SELECTION_LABEL.format(
                        comet_number))
